...
type RegisterRequest struct {
	...
	PreSharedToken string                 `protobuf:"bytes,1,opt,name=pre_shared_token,json=preSharedToken,proto3" json:"pre_shared_token,omitempty"`
...
const file_internal_pkg_worker_proto_worker_proto_rawDesc = "" +
	"\n" +
	"&internal/pkg/worker/proto/worker.proto\x12\tworker.v1\"\xfa\x01\n" +
	"\x0fRegisterRequest\x12(\n" +
	"\x10pre_shared_token\x18\x01 \x01(\tR\x0epreSharedToken\x12D\n" +
	"\bmetadata\x18\x02 \x03(\v2(.worker.v1.RegisterRequest.MetadataEntryR\bmetadata\x12!\n" +
	"\fruntime_type\x18\x03 \x01(\tR\vruntimeType\x12\x17\n" +
	"\acsr_pem\x18\x04 \x01(\fR\x06csrPem\x1a;\n" +
